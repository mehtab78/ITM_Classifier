...
if __name__ == "__main__":
    ...
    # Paths and files
    IMAGES_PATH = "/ITM_Classifier/visual7w-images"
    train_data_file = "/ITM_Classifier/visual7w-text/v7w.TrainImages.itm.txt"
    dev_data_file = "/ITM_Classifier/visual7w-text/v7w.DevImages.itm.txt"
    test_data_file = "/ITM_Classifier/visual7w-text/v7w.TestImages.itm.txt"
    sentence_embeddings_file = (
        "/ITM_Classifier/v7w.sentence_embeddings-gtr-t5-large.pkl"
    )
